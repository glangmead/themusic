...
extension ArrowSyntax: Codable {
  ...
  private enum CaseKey: String, CodingKey {
    ...
    case libraryArrow, emitterValue, quickExpression, osc, wavetable, padSynthWavetable, bitCrusher
  }
  ...
  private struct PadSynthWavetablePayload: Codable, Equatable { let name: String; let params: PADSynthSyntax; let width: ArrowSyntax }
  ...
  init(from decoder: Decoder) throws {
    ...
    } else if container.contains(.padSynthWavetable) {
      let p = try container.decode(PadSynthWavetablePayload.self, forKey: .padSynthWavetable)
      self = .padSynthWavetable(name: p.name, params: p.params, width: p.width)
  ...
  func encode(to encoder: Encoder) throws {
    ...
    case .padSynthWavetable(let name, let params, let width):
      try container.encode(PadSynthWavetablePayload(name: name, params: params, width: width), forKey: .padSynthWavetable)
